...
CREATE TABLE IF NOT EXISTS rm_bids (
    ...
    tm_bid_count INTEGER DEFAULT 0,
    rank INTEGER,
...
CREATE TABLE IF NOT EXISTS financials (
    ...
    rm_spot_vol INTEGER DEFAULT 0,
    rm_spot_cost_paise BIGINT DEFAULT 0,
    ...
    sales_vol INTEGER DEFAULT 0,
    
    cash_opening_paise INTEGER DEFAULT 0,
    cash_inflow_paise BIGINT DEFAULT 0,
